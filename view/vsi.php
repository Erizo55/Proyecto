			...
			<div class="cont_section">
				...
				<div class="trabajos">
					...
					<div class="panel_general">
                                            <form method="post" style="margin:0;" class='formulario_registro' action='index.php?location=si&subirtrabajo=true' enctype="multipart/form-data">
						...
						<?php
                                                    ...
                                                    $directorioraiz='/public_html/archivos/si/';
				...
				<div class="examenes">
					<p>EXAMENES</p>
					<div class="panel_general">
                                                <form method="post" style="margin:0;" class='formulario_registro' action='index.php?location=si&subirexamen=true' enctype="multipart/form-data">
							<div class="titulo_registro">
								<h1>Subir archivo</h1>
                                                                    <?php
