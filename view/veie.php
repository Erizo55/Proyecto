			...
			<div class="cont_section">
                                            ...
                                            if($atributos="*asignaturasAlumno"){
                                                foreach($value as $atributos2 => $value2){
                                                    if($value2=="SISTEMAS INFORMATICOS"){
                                                        ...
                                                        echo "<button ".$classactivo." onclick=".'"'."location.href='index.php?location=eie'".'"'.">".$value2."</button>";
                                                    }
                                                }
                                            }
                                        }
				...
				<div class="trabajos">
					...
					<div class="panel_general">
                                            <form method="post" style="margin:0;" class='formulario_registro' action='index.php?location=eie&subirtrabajo=true' enctype="multipart/form-data">
						...
						<?php
                                                    ...
                                                    $directorioraiz='/public_html/archivos/eie/';
				...
				<div class="examenes">
					<p>EXAMENES</p>
					<div class="panel_general">
                                                <form method="post" style="margin:0;" class='formulario_registro' action='index.php?location=eie&subirexamen=true' enctype="multipart/form-data">
							<div class="titulo_registro">
								<h1>Subir archivo</h1>
                                                                    <?php
